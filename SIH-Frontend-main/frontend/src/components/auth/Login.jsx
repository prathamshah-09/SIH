  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${theme.colors.background} flex items-center justify-center p-4 relative ${isRTL ? 'rtl' : 'ltr'}`}>
      ...
      {/* <div className="absolute top-4 left-4 z-20">
        <div className={`${theme.colors.card} px-4 py-2 rounded-full border-2 border-yellow-400 shadow-lg`}>
          <div className="flex items-center space-x-2">
            <Shield className="w-4 h-4 text-yellow-500" />
            <span className="text-sm font-semibold text-yellow-600">National Project</span>
          </div>
        </div>
      </div> */}
